...
Current gameplay coverage includes 2-20 character player handles, 4P / 6P / 8P room creation, public-room join, host start, bot fill, Easy/Medium bot turns, token-protected moves, SSE with automatic long-poll replay fallback, hidden-state filtering, round-end and game-end progression, level advancement through A, 4P tribute/return/anti-tribute, 6P/8P normal and sweep tribute paths, optional exchange-card flow with losing-team vote before tribute and 3-card selection after returns, disconnect takeover/reclaim, and active-room reconnect from local storage.
